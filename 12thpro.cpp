...
using namespace std;
   ...
   char l_destination[5][20]={"CHENNAI","DELHI","BANGALORE","KOCHI","MADURAI"};
       char i_destination[10][20]={"LONDON","BERLIN","DUBAI","NEW YORK","BEIJING","PARIS","CAPE TOWN","TOKYO","LOS ANGELES","COLOMBO" };
class mytime
{
protected:
 int choose;
...
public:
 void getdata()
 {
  ...
  case 1:
   if (option==1)
    cout<<setw(40)<<"\n\n\n                                WELCOME TO JET AIRWAYS"<<endl;
   break;
  case 2:
   if(option==2)
    cout<<setw(40)<<"\n\n\n                                WELCOME TO SPICE"<<endl;
   break;
  case 3:
   if(option==3)
...
m:
  ...
  system("cls");
 ...
 
   {
    ...
    cout<<setw(40)<<"GOOD BYE l AIR RESERVATION SYSTEM";
 ...
 
   {
    ...
    cout<<setw(40)<<"GOOD BYE |AIR RESERVATION SYSTEM";
...
int main()
{ SetConsoleTitle("AIRLINE RESERVATION");
 system("color 5f");
